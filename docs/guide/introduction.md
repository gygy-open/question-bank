...
**QuestionBank（题库系统）** 是一个 AI 原生的题库管理系统，面向教研团队、教师与培训机构等，帮助你把散落在 Word、Markdown、图片中的题目，快速抽取成结构化、可检索、可组卷的题库。
...
QuestionBank 提供两种部署形态，请先阅读 [版本与选型](/guide/editions) 选择适合你的方式：
