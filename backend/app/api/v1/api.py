...
from app.api.v1.endpoints import subjects, knowledge_points, tags, tag_categories, questions, upload, login, users, system_settings, ai_config, chat, tools, activity_logs, import_tasks, prompts, setup, system, subject_prompts, compositions, assessments
...
api_router.include_router(assessments.router, prefix="/subjects", tags=["assessments"])
