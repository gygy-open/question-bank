...
def downgrade() -> None:
    ...
    op.drop_table('question_group_items')
    with op.batch_alter_table('question_groups', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_question_groups_subject_id'))
        batch_op.drop_index(batch_op.f('ix_question_groups_stimulus_id'))
        batch_op.drop_index(batch_op.f('ix_question_groups_id'))
        batch_op.drop_index(batch_op.f('ix_question_groups_deleted_at'))

    op.drop_table('question_groups')
    with op.batch_alter_table('stimuli', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_stimuli_subject_id'))
        batch_op.drop_index(batch_op.f('ix_stimuli_id'))
        batch_op.drop_index(batch_op.f('ix_stimuli_deleted_at'))
